    ...
    7: function (t, e, n) {
        ...
        function V(t) {
            ...
            if (u) {
                ...
                T === x(n) && (T = R(n)),
                    l === s &&
                        ((w = o),
                        (_ -= T.clientHeight - i.height),
                        (_ *= h ? 1 : -1)),
                    l === a &&
                        ((y = r),
                        (g -= T.clientWidth - i.width),
                        (g *= h ? 1 : -1));
            }
            var A,
        ...
        function ut(t, e) {
            ...
            var n = e,
                ...
                k = t.elements[y ? A : b],
                D = ct(
                    C(k) ? k : k.contextElement || R(t.elements.popper),
                    d,
                    m
                ),
                x = nt(O),
        ...
        class he extends de {
            ...
            _removeElement(t) {
                ...
                const e = jt(t);
                ce.one(t, "transitionend", () => this._destroyElement(t)),
                    It(t, e);
            }
            _destroyElement(t) {
        ...
        const ge = {
                ...
                getDataAttribute: (t, e) =>
                    fe(t.getAttribute("data-bs-" + pe(e))),
                offset(t) {
        ...
        class Le extends de {
            ...
            _addEventListeners() {
                this._config.keyboard &&
                    ce.on(this._element, "keydown.bs.carousel", (t) =>
                        this._keydown(t)
                    ),
            ...
            _addTouchEventListeners() {
                ...
                me.find(".carousel-item img", this._element).forEach((t) => {
                    ce.on(t, "dragstart.bs.carousel", (t) =>
                        t.preventDefault()
                    );
                }),
                    this._pointerEvent
                        ? (ce.on(
                          ...
                          ce.on(this._element, "pointerup.bs.carousel", (t) =>
                              n(t)
                          ),
                          this._element.classList.add("pointer-event"))
                        : (ce.on(this._element, "touchstart.bs.carousel", (e) =>
                              t(e)
                          ),
                          ce.on(this._element, "touchmove.bs.carousel", (t) =>
                              e(t)
                          ),
                          ce.on(this._element, "touchend.bs.carousel", (t) =>
                              n(t)
                          ));
            }
            _keydown(t) {
                /input|textarea/i.test(t.target.tagName) ||
                    ("ArrowLeft" === t.key
                        ...
                        : "ArrowRight" === t.key &&
                          (t.preventDefault(), this._slide(Ee)));
            }
            _getItemIndex(t) {
                return (
                    (this._items =
                        t && t.parentNode
                            ? me.find(".carousel-item", t.parentNode)
                            : []),
        ...
        class xe extends de {
            ...
            show() {
                ...
                if (t) {
                    ...
                    if (
                        ((e = i ? qt.get(i, "bs.collapse") : null),
                        e && e._isTransitioning)
                    )
                        return;
                }
                if (
                    ce.trigger(this._element, "show.bs.collapse")
                        .defaultPrevented
                )
                    return;
                t &&
            ...
            hide() {
                if (
                    ...
                    return;
                if (
                    ce.trigger(this._element, "hide.bs.collapse")
                        .defaultPrevented
                )
                    return;
        ...
        class Be extends de {
            ...
            show() {
                if (Rt(this._element) || this._menu.classList.contains("show"))
                    return;
                const t = Be.getParentFromElement(this._element),
                    e = { relatedTarget: this._element };
                if (
                    !ce.trigger(this._element, "show.bs.dropdown", e)
                        .defaultPrevented
                ) {
                    if (this._inNavbar)
                        ge.setDataAttribute(this._menu, "popper", "none");
                    else {
                        if (void 0 === i)
                            throw new TypeError(
            ...
            static dataApiKeydownHandler(t) {
                ...
                if ("Escape" === t.key)
                    return n().focus(), void Be.clearMenus();
        ...
        class Ge extends de {
            ...
            hide(t) {
                if (
                    ...
                    return;
                if (ce.trigger(this._element, "hide.bs.modal").defaultPrevented)
                    return;
                this._isShown = !1;
                ...
                if (
                    ...
                    ce.one(this._element, "transitionend", (t) =>
                        this._hideModal(t)
                    ),
                        It(this._element, t);
            ...
            _showElement(t) {
                ...
                const i = () => {
                    this._config.focus && this._element.focus(),
                        (this._isTransitioning = !1),
                        ce.trigger(this._element, "shown.bs.modal", {
                            relatedTarget: t,
                        });
                };
                if (e) {
                    const t = jt(this._dialog);
                    ce.one(this._dialog, "transitionend", i),
                        It(this._dialog, t);
                } else i();
            }
            _enforceFocus() {
            ...
            _triggerBackdropTransition() {
                if (
                    ce.trigger(this._element, "hidePrevented.bs.modal")
                        .defaultPrevented
                )
                    return;
                const t =
        ...
        class sn extends de {
            ...
            show(t) {
                ...
                if (
                    ce.trigger(this._element, "show.bs.offcanvas", {
                        relatedTarget: t,
                    }).defaultPrevented
                )
                    return;
            ...
            hide() {
                if (!this._isShown) return;
                if (
                    ce.trigger(this._element, "hide.bs.offcanvas")
                        .defaultPrevented
                )
                    return;
        ...
        const on = new Set([
            ...
            ln = (t, e) => {
                ...
                if (e.includes(n))
                    return (
                        !on.has(n) ||
                        Boolean(rn.test(t.nodeValue) || an.test(t.nodeValue))
                    );
        ...
        class On extends de {
            ...
            _getConfig(t) {
                if (
                    ...
                    let { id: e } = t.target;
                    e || ((e = Dt("scrollspy")), (t.target.id = e)),
                        (t.target = "#" + e);
                }
        ...
        class Ln extends de {
            ...
            show() {
                ...
                const i = t
                    ? ce.trigger(t, "hide.bs.tab", {
                          relatedTarget: this._element,
                      })
                    : null;
                if (
                    ce.trigger(this._element, "show.bs.tab", {
                        relatedTarget: t,
                    }).defaultPrevented ||
        ...
        class xn extends de {
            ...
            show() {
                if (ce.trigger(this._element, "show.bs.toast").defaultPrevented)
                    return;
                this._clearTimeout(),
            ...
            hide() {
                ...
                if (ce.trigger(this._element, "hide.bs.toast").defaultPrevented)
                    return;
                const t = () => {
