<x-app-layout>
  ...
  <div class="card">
    <div class="card-content">
      <div class="card-body">
        <form class="form form-horizontal" method="POST" action="{{ route('proposal.update', $proposal->id) }}" enctype="multipart/form-data">
          @csrf
          @method('PATCH')
          <div class="form-body">
            <div class="row">
              ...
              <div class="col-md-8 form-group">
                <a href="{{ Storage::url($proposal->file1) }}" target="_blank" rel="noopener noreferrer">
                  <small class="fw-bold"><i class="bi bi-card-text text-dark" style="font-size: 28px"></i></small>
                </a>

                <input type="file" class="form-control @error('file1') is-invalid @enderror" name="file1" value="{{ old('file1') }}" />
              ...
              <div class="col-md-8 form-group">
                ...
                <a href="{{ Storage::url($proposal->file2) }}" target="_blank" rel="noopener noreferrer">
                  <small class="fw-bold"><i class="bi bi-card-text text-dark" style="font-size: 28px"></i></small>
                </a>
                @endif
              ...
              <div class="col-md-8 form-group">
                ...
                <a href="{{ Storage::url($proposal->file3) }}" target="_blank" rel="noopener noreferrer">
                  <small class="fw-bold"><i class="bi bi-card-text text-dark" style="font-size: 28px"></i></small>
                </a>
                @endif
