<div class="table-responsive-lg">
    <table class="table app-table-hover mb-0 text-left">
        ...
        <tr>
            ...
            <th>:</th>
            <td><a href="{{ Storage::url($mahasiswa->seminar->krs) }}" target="_blank" rel="noopener noreferrer"
        ...
        <tr>
            ...
            <th>:</th>
            <td><a href="{{ Storage::url($mahasiswa->seminar->transkip_nilai) }}" target="_blank"
        ...
        <tr>
            ...
            <th>:</th>
            <td><a href="{{ Storage::url($mahasiswa->seminar->laporan_kp) }}" target="_blank"
                    rel="noopener noreferrer" class="btn btn-sm btn-primary"
                    style="padding: 2px 8px !important">Unduh</a></td>
        </tr>
        ...
        <tr>
            ...
            <th>:</th>
            <td><a href="{{ Storage::url($mahasiswa->seminar->keuangan) }}" target="_blank" rel="noopener noreferrer"
                    class="btn btn-sm btn-primary" style="padding: 2px 8px !important">Unduh</a></td>
        </tr>
        ...
        <tr>
            ...
            <th>:</th>
            <td><a href="{{ Storage::url($mahasiswa->seminar->konsultasi) }}" target="_blank"
                    rel="noopener noreferrer" class="btn btn-sm btn-primary"
                    style="padding: 2px 8px !important">Unduh</a></td>
        </tr>
