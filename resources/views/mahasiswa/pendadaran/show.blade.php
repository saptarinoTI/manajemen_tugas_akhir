<div class="table-responsive-lg">
    <table class="table app-table-hover mb-0 text-left">
        <tr>
            ...
            <th>:</th>
            <td>{{ ucwords($pendadaran->mahasiswa->tmpt_lahir) . ', ' . date('d M Y', strtotime($pendadaran->mahasiswa->tgl_lahir)) }}
            </td>
        </tr>
        ...
        <tr>
            ...
            <th>:</th>
            <td><a href="{{ Storage::url($pendadaran->krs) }}" target="_blank" rel="noopener noreferrer"
        ...
        <tr>
            ...
            <th>:</th>
            <td><a href="{{ Storage::url($pendadaran->transkip_nilai) }}" target="_blank" rel="noopener noreferrer"
                    class="btn btn-sm btn-primary" style="padding: 2px 8px !important">Unduh</a></td>
        </tr>
        ...
        <tr>
            ...
            <th>:</th>
            <td><a href="{{ Storage::url($pendadaran->konsultasi) }}" target="_blank" rel="noopener noreferrer"
                    class="btn btn-sm btn-primary" style="padding: 2px 8px !important">Unduh</a></td>
        </tr>
        ...
        <tr>
            ...
            <th>:</th>
            <td><a href="{{ Storage::url($pendadaran->perkuliahan) }}" target="_blank" rel="noopener noreferrer"
                    class="btn btn-sm btn-primary" style="padding: 2px 8px !important">Unduh</a></td>
        </tr>
        ...
        <tr>
            ...
            <th>:</th>
            <td><a href="{{ Storage::url($pendadaran->keuangan) }}" target="_blank" rel="noopener noreferrer"
                    class="btn btn-sm btn-primary" style="padding: 2px 8px !important">Unduh</a></td>
        </tr>
        ...
        <tr>
            ...
            <th>:</th>
            <td><a href="{{ Storage::url($pendadaran->perpustakaan) }}" target="_blank" rel="noopener noreferrer"
                    class="btn btn-sm btn-primary" style="padding: 2px 8px !important">Unduh</a></td>
        </tr>
        ...
        <tr>
            ...
            <th>:</th>
            <td><a href="{{ Storage::url($pendadaran->laboratorium) }}" target="_blank" rel="noopener noreferrer"
                    class="btn btn-sm btn-primary" style="padding: 2px 8px !important">Unduh</a></td>
        </tr>
        ...
        <tr>
            ...
            <th>:</th>
            <td><a href="{{ Storage::url($pendadaran->action) }}" target="_blank" rel="noopener noreferrer"
                    class="btn btn-sm btn-primary" style="padding: 2px 8px !important">Unduh</a></td>
        </tr>
        ...
        <tr>
            ...
            <th>:</th>
            <td><a href="{{ Storage::url($pendadaran->kompetensi) }}" target="_blank" rel="noopener noreferrer"
                    class="btn btn-sm btn-primary" style="padding: 2px 8px !important">Unduh</a></td>
        </tr>
        ...
        <tr>
            ...
            <th>:</th>
            <td><a href="{{ Storage::url($pendadaran->toefl) }}" target="_blank" rel="noopener noreferrer"
                    class="btn btn-sm btn-primary" style="padding: 2px 8px !important">Unduh</a></td>
        </tr>
        ...
        <tr>
            ...
            <th>:</th>
            <td><a href="{{ Storage::url($pendadaran->ijazah) }}" target="_blank" rel="noopener noreferrer"
                    class="btn btn-sm btn-primary" style="padding: 2px 8px !important">Unduh</a></td>
        </tr>
        ...
        <tr>
            ...
            <th>:</th>
            <td><a href="{{ Storage::url($pendadaran->ktp) }}" target="_blank" rel="noopener noreferrer"
                    class="btn btn-sm btn-primary" style="padding: 2px 8px !important">Unduh</a></td>
        </tr>
        ...
        <tr>
            ...
            <th>:</th>
            <td><a href="{{ Storage::url($pendadaran->akte) }}" target="_blank" rel="noopener noreferrer"
                    class="btn btn-sm btn-primary" style="padding: 2px 8px !important">Unduh</a></td>
        </tr>
        ...
        <tr>
            ...
            <th>:</th>
            <td><a href="{{ Storage::url($pendadaran->foto) }}" target="_blank" rel="noopener noreferrer"
                    class="btn btn-sm btn-primary" style="padding: 2px 8px !important">Unduh</a></td>
        </tr>
